...
meine_trainings_programme = [
    ...
    ("K3", "erzeuge_trainingsprogramm_K3((34, 80), (100, 50), intervall_dauer=6, ausfahrzeit=5))",
        tp.erzeuge_trainingsprogramm_K3((34, 80), (100, 50), intervall_dauer=6, ausfahrzeit=5)),
