...
class test_Ergometer(TestCase):
    ...
    def test_bremse_minus_minus(self):
        ...
        ergo.bremseMinusMinus('Intervall')
        self.assertEqual(ergo.bremse, 95)
        self.assertEqual({'Intervall': -5}, ergo.korrekturwerte_bremse)
    ...
    def test_korrigiere_bremswert(self):
        ...
        self.assertEqual(100, ergo.bremse)
        self.assertEqual({}, ergo.korrekturwerte_bremse)
        ergo.korrigiere_bremswert(name='Intervall', wert=5)
        self.assertEqual(100, ergo.bremse)
        self.assertEqual({'Intervall': 5}['Intervall'], ergo.korrekturwerte_bremse['Intervall'])
        ergo.korrigiere_bremswert(name='Intervall', wert=-15)
        self.assertEqual(100, ergo.bremse)
        self.assertEqual({'Intervall': -10}['Intervall'], ergo.korrekturwerte_bremse['Intervall'])
